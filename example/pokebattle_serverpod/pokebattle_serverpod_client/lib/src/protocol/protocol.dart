...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i5.Pokemon) {
      return _i5.Pokemon.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i5.Pokemon?>()) {
      return (data != null ? _i5.Pokemon.fromJson(data) : null) as T;
    }
    if (t == List<String>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Pokemon') {
      return deserialize<_i5.Pokemon>(data['data']);
    }
    return super.deserializeByClassName(data);
  }
