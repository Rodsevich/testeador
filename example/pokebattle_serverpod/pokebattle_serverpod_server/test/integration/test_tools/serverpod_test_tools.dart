...
class TestEndpoints {
  ...
  late final _PlayersEndpoint players;

  late final _PokemonEndpoint pokemon;
}
...
class _BattlesEndpoint {
  ...
  _i3.Future<_i5.Battle> createBattle(
    _i1.TestSessionBuilder sessionBuilder,
  ...
  _i3.Future<_i5.Battle> getBattle(
    _i1.TestSessionBuilder sessionBuilder,
    String id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<List<_i5.Battle>> listBattles(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
  ...
  _i3.Stream<_i5.Battle> battleAdded(_i1.TestSessionBuilder sessionBuilder) {
    var _localTestStreamManager = _i1.TestStreamManager<_i5.Battle>();
  ...
  _i3.Stream<_i5.Battle> battleUpdates(
    _i1.TestSessionBuilder sessionBuilder,
    String id,
  ) {
    var _localTestStreamManager = _i1.TestStreamManager<_i5.Battle>();
    _i1.callStreamFunctionAndHandleExceptions(
      () async {
        var _localUniqueSession =
            (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
              endpoint: 'battles',
              method: 'battleUpdates',
            );
        var _localCallContext = await _endpointDispatch
            .getMethodStreamCallContext(
              createSessionCallback: (_) => _localUniqueSession,
              endpointPath: 'battles',
              methodName: 'battleUpdates',
              arguments: {'id': id},
              requestedInputStreams: [],
              serializationManager: _serializationManager,
            );
...
class _PokemonEndpoint {
  ...
  _i3.Future<_i7.Pokemon> getPokemon(
    _i1.TestSessionBuilder sessionBuilder,
    String name,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
