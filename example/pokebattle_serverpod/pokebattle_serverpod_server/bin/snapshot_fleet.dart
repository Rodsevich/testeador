...
//
// Lives in the server package (which resolves with `testeador` outside the
// Flutter workspace) so the Flutter app under test stays free of the
// testeador↔flutter_test (meta) version conflict.
//
// Usage:
//
...
//
// `testeador` is a dev_dependency of this package; this dev-only `bin/` script
// legitimately imports it. Silencing the false-positive lint:
