...
import 'package:testeador_base/src/capture/secret_redactor.dart';

/// Emits a **draft** testeador contract test for one uncovered endpoint,
/// seeded from a real observed exchange.
///
/// The output is a `TestStep` builder importing only `package:testeador_base/...`
...
class TestUnitEmitter {
  ...
  String emit(EndpointGap gap) {
    ...
    b
      ..writeln("import 'package:testeador_base/expect.dart';")
      ..writeln("import 'package:testeador_base/testeador_base.dart';")
      ..writeln()
      ..writeln(
